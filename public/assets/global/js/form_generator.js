class FormGenerator{
    ...
    extraFields(fieldType){
        ...
        if (this.fieldType == 'file') {
            ...
            var title = `Extensión de archivos <small class="text--danger">*</small> <small class="text-primary">(Separar cada elemento por coma)</small>`;
        }else{
    ...
    formEdit(element){
        ...
        if (formItem.type == 'file') {
            html += `
                <div class="d-flex justify-content-between flex-wrap">
                    <label>Extensión de archivos <small class="text--danger">*</small> <small class="text-primary">(Separar cada elemento por coma)</small></label>
                </div>
                <div class="mt-2">
                    <div class="form-group">
