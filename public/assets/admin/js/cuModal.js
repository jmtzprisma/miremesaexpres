		...
		if (data.has_status) {
			cuModal.find(".status").html(`
				<div class="form-group">
					...
					<input type="checkbox" data-width="100%" data-height="45" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="Activo" data-off="Inactivo" name="status">
				</div>
			`);
