...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        $hideBreadcrumb = true;
        return view($this->activeTemplate . 'user.auth.register', compact('pageTitle', 'mobileCode', 'countries', 'hideBreadcrumb'));
    }
    ...
    public function register(Request $request)
    {
        ...
        $request->merge([
            ...
            'password_confirmation' => CryptoJsAes::decrypt($request->crypt_confpwd, $pwd),
        ]);
        ...
        if (preg_match("/[^a-z0-9_]/", trim(strtolower($request->username)))) {
        ...
        if ($exist) {
            $notify[] = ['error', 'El número de móvil ya existe'];
