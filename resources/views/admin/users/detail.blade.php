            ...
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget 
                        ...
                        link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" 
                        style="3" 
                        title="Refunded Balance" 
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget 
                        ...
                        color="white" 
                        icon="las la-wallet" 
                        link="{{ route('admin.send.money.all') }}?search={{ $user->username }}" 
                        style="3" 
                        title="Sent Money" 
                        value="{{ $general->cur_sym }}{{ showAmount($totalSendMoney) }}" 
                    />
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget 
                        ...
                        color="white" 
                        icon="fas fa-wallet" 
                        link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" 
                        style="3" 
                        title="Payments" 
