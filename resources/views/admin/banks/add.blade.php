    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card b-radius--5 overflow-hidden">
                <div class="card-body">
                    <form action="{{ route('admin.bank.store') }}" method="POST" class="verify-gcaptcha row">
                        @csrf
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="name_account" type="text" class="form-control" name="name_account" value="{{ old('name_account') }}" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="codigo_banco" type="text" class="form-control" name="codigo_banco" value="{{ old('codigo_banco') }}" required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="recibe">@lang('Recibe')</label>
                            <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Si')" data-off="@lang('No')" name="recibe" id="recibe">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="envia">@lang('Envia')</label>
                            <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Si')" data-off="@lang('No')" name="envia" id="envia">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input id="average_rate" type="text" class="form-control" name="average_rate" value="{{ old('average_rate') }}" required>
                        </div>
                        <div class="form-group col-md-3">
                            <label> @lang('Cuenta para cuentas de criptopocket')</label>
                            <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="only_criptopocket">
                        </div>
