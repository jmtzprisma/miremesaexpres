                            ...
                            <tbody>
                                @forelse ($sourceOfFunds as $sourceOfFund)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge--{{ $sourceOfFund->status == Status::DISABLE ? 'danger' : 'success' }}">{{ $sourceOfFund->status == Status::DISABLE ? trans('Disabled') : trans('Active') }}</span>
                                        </td>

                                        <td>
                                            <a href="#" class="btn btn-primary shadow btn-xs sharp me-1 cuModalBtn ml-1" data-modal_title="@lang('Update Source of Fund')" data-resource="{{ $sourceOfFund }}" data-has_status="1"><i class="la la-edit"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
